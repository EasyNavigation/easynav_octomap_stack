...
#ifndef EASYNAV_OUTDOOR_MAPS_BUILDER__OCTOMAPMAPSBUILDERNODE_HPP_
#define EASYNAV_OUTDOOR_MAPS_BUILDER__OCTOMAPMAPSBUILDERNODE_HPP_
...
private:
  ...
  /// Topic name for sensor point cloud subscription.
  ...
  /// Buffer holding the current perception point clouds.
  std::vector<std::shared_ptr<Perception>> perceptions_;
...
#endif  // EASYNAV_OUTDOOR_MAPS_BUILDER__OCTOMAPMAPSBUILDERNODE_HPP_
